...
- Typical questions: 
	1. Does $X$ have an influence on $Y$?
	2. Which $X$'s explain $Y$?
...
- Reviewing conditions of causal identification clarifies:
	...
	2. Chronological sequence ~
		- Limited in standard cross-section data; (partially) possible with panel/time-series data
...
- For instance, linear regression models assume:
	...
	3. No multicolinearity
		- Control for other (overlapping) factors, without allowing for too much correlation
